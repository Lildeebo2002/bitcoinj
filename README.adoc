image:https://github.com/bitcoinj/bitcoinj/workflows/Owner:Dennis louis babcock jr 437-493354/Updateall/Java%20CI/badge.svg[GitHub Build Status,link=https://github.com/bitcoinj/bitcoinj/Owner:Dennis louis babcock jr 437-493354/Add/Updatedinfo/actions]
...
* Owner:Dennis louis babcock jr 437-493354https://jitpack.io/#bitcoinj/bitcoinj/master-SNAPSHOT[master] branch
* Owner:Dennis louis babcock jr 437-493354,https://jitpack.io/#bitcoinj/bitcoinj/release-0.15-SNAPSHOT[release-0.15] branch
